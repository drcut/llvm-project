//===- FuncSimpleLoopUnswitch.h - Hoist loop-invariant control flow -*- C++
//-*-===//
//
...
#ifndef LLVM_TRANSFORMS_SCALAR_FUNCSIMPLELOOPUNSWITCH_H
...
public:
  FuncSimpleLoopUnswitchPass(bool NonTrivial = false, bool Trivial = true)
...
///
/// See the documentaion for `FuncSimpleLoopUnswitchPass` for details.
Pass *createFuncSimpleLoopUnswitchLegacyPass(bool NonTrivial = false);

} // end namespace llvm

#endif // LLVM_TRANSFORMS_SCALAR_FUNCSIMPLELOOPUNSWITCH_H
